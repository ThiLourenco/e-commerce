...
export const inventory: InventoryProduct[] = [
  ...
  },
  {
    ...
    colors: ["preto"],
    currency: "BRL",
    composition: " Material da armação: Polipropileno - Material da Lente: Acrílico",
    additionalInformation: "Comprimento da Haste: 13,8cm - Altura da Lente: 4,8cm - Largura Total: 13,7cm - Largura da Lente: 5,5cm Vantagens das lentes polarizadas e proteção UV400"
  },
]
